/*! For license information please see 546641dfde76ed00139ea2c3eae09499c5f2164a-eba2b75a08dfa4b564cf.js.LICENSE.txt */
  ...
  [98],
  {
      ...
      var s = function (e) {
          function t(e, r, l, c, f) {
            for (
              ...
              if (
                ...
                switch (m) {
                  case 123:
                    ...
                    if (
                      ((h = l.substring(F, R)),
                      0 === p && (p = (H = H.replace(u, '').trim()).charCodeAt(0)),
                      64 === p)
                    ) {
                      ...
                      if (
                        ...
                        0 < P &&
                          ((x = s(3, h, (_ = n(I, H, D)), r, O, T, F, m, f, c)),
                          (H = _.join('')),
                  ...
                  case 125:
                  case 59:
                    if (1 < (F = (H = (0 < _ ? H.replace(d, '') : H).trim()).length))
                      switch (
                        (0 === z &&
                          ((p = H.charCodeAt(0)), 45 === p || (96 < p && 123 > p)) &&
                          (F = (H = H.replace(' ', ':')).length),
                        0 < P &&
                          void 0 !== (x = s(1, H, r, e, O, T, $.length, c, f, c)) &&
                          0 === (F = (H = x.trim()).length) &&
                          (H = '\0\0'),
                        (p = H.charCodeAt(0)),
                        (m = H.charCodeAt(1)),
              ...
              switch (m) {
                ...
                case 10:
                  47 === k
                    ? (k = 0)
                    : 0 === 1 + p && 107 !== c && 0 < H.length && ((_ = 1), (H += '\0')),
                    0 < P * M && s(0, H, r, e, O, T, $.length, c, f, c),
                    (T = 1),
                    O++;
                  break;
                case 59:
            ...
            if (0 < (F = $.length)) {
              if (
                ((_ = r),
                0 < P && void 0 !== (x = s(2, $, _, e, O, T, F, c, f, c)) && 0 === ($ = x).length)
              )
                return W + $ + q;
              if ((($ = _.join(',') + '{' + $ + '}'), 0 != L * j)) {
          ...
          function l(e) {
            return (
              void 0 !== (e = e.prefix) &&
                ((z = null), e ? ('function' != typeof e ? (L = 1) : ((L = 2), (z = e))) : (L = 0)),
              l
            );
          }
          function c(e, n) {
            ...
            if (o) {
              ...
              if (s) {
                var l = 0 | parseInt(s[1], 10),
                  c = s[2];
                0 !== l && (N(c, l), M(e, c, s[3]), e.getTag().insertRules(l, r)), (r.length = 0);
              } else r.push(o);
            }
          }
        },
              ...
              if (
                ...
                if (this.staticRulesId && t.hasNameForId(r, this.staticRulesId))
                  ...
                  var a = ge(this.rules, e, t, n).join(''),
                    o = G(V(this.baseHash, a.length) >>> 0);
                ...
                for (
                  var l = this.rules.length, c = V(this.baseHash, n.hash), u = '', d = 0;
                  d < l;
                  d++
                ) {
                  var f = this.rules[d];
        ...
        return (
          ...
          (k.withComponent = function (e) {
            var r = t.componentId,
              ...
              a = r && r + '-' + (ke(e) ? e : we(y(e)));
            return Ie(e, p({}, i, { attrs: w, componentId: a }), n);
          }),
    ...
    7140: function (e, t, n) {
      ...
      function Le(e, t) {
        ...
        t))
          Y.key(i) && n.push({ name: i, tweens: je(t[i], e) });
        return n;
      }
      function Ie(e, t) {
        var n;
      ...
      var $e = Be,
              ...
              l
                ...
                : r.createElement(
                    ...
                    o &&
                      r.createElement(
                        Ve.Z,
                        { classNames: n ? 'fade' : '', timeout: n ? Je.Cs : 0 },
                        t,
                      ),
                  ),
            )
        ...
        gt = function () {
          var e = (0, r.useState)({ stars: null, forks: null }),
            t = e[0],
            n = e[1];
          return (
            (0, r.useEffect)(function () {
                  ...
                  t.stars &&
                    ...
                    r.createElement(
                      ...
                      r.createElement(
                        'span',
                        null,
                        r.createElement(qe.JO, { name: 'Star' }),
                        r.createElement('span', null, t.stars.toLocaleString()),
                      ),
                      r.createElement(
                        'span',
                        null,
                        r.createElement(qe.JO, { name: 'Fork' }),
              ...
              : r.createElement(
                  ...
                  t &&
                    a.map(function (e, t) {
                      return r.createElement(
                        Ve.Z,
                        { key: t, classNames: 'fadeup', timeout: Je.Cs },
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    'p',
                    null,
                    "Hi there! My name is Kenneth, and I enjoy making things. Whether it be whipping up a new web game or cooking my favorite Korean dish, I'm always looking for ways to channel my inner designer. My interest in computer science started back in high school, where I learned MATLAB to run simple machine learning models on noisy data. After coming to MIT, my scope expanded greatly to include many fields within software, systems, and machine learning.",
                  ),
                  r.createElement(
                    'p',
                    null,
                    "Currently, I'm a software engineer intern at Amazon working on the Visual Search & Augmented Reality team. I'm also co-president of",
                    ' ',
                    r.createElement('a', { href: 'https://weblab.mit.edu/' }, 'MIT web.lab'),
                    ' ',
                    ', a programming class & competition that takes place every January. Last year, I was academic chair for web.lab, and we had over 400 enrolled students and over 80 projects submitted!',
                  ),
                  r.createElement(
                    'p',
                    null,
        ...
        _t = function () {
          ...
          (0, r.useEffect)(function () {
            c ||
              (xt.Z.reveal(a.current, (0, Ue.srConfig)()),
              xt.Z.reveal(s.current, (0, Ue.srConfig)()),
                ...
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      'div',
                      { className: 'folder' },
                      r.createElement(qe.JO, { name: 'Folder' }),
                    ),
                    r.createElement(
                      'div',
                      { className: 'project-links' },
              ...
              c
                ? r.createElement(
                    ...
                    f &&
                      f.map(function (e, t) {
                        var n = e.node;
                        return r.createElement(Rt, { key: t }, p(n));
                      }),
                  )
                : r.createElement(
                    Ge.Z,
    ...
    355: function (e, t, n) {
          ...
          if (((n.models = { visible: i, revealed: a }), !a.body.length)) {
            ...
            if (s)
              return (
                ...
                D.call(this, n, i.body[0], 1, t),
                I.call(this, s, { reveal: !0, pristine: t })
              );
          }
          if (!n.blocked.head && r === [].concat(a.head).pop() && r >= [].concat(i.body).shift())
            return D.call(this, n, r, -1, t), I.call(this, e, { reveal: !0, pristine: t });
      ...
      function F(e, t, n) {
        ...
        b(o, function (e) {
          ...
          !0 !== n &&
            ...
            (this.initTimeout = window.setTimeout(L.bind(this), 0)));
      }
      function B() {
        var e = this;
        ...
        void 0 === e && (e = { type: 'init' }),
          ...
          m(function () {
            ...
            b(n.store.containers, function (e) {
              ...
              var t = $.call(n, e);
              e.scroll &&
                (e.direction = { x: Z(t.left - e.scroll.left), y: Z(t.top - e.scroll.top) }),
                (e.scroll = t);
            }),
              b(t, function (e) {
              ...
              b(t, function (e) {
                e.sequence ? M.call(n, e) : I.call(n, e);
              }),
              (n.pristine = !1);
          });
      }
      ...
      function ee(e) {
        ...
        return (!(X = t).mobile && T()) || (!X.desktop && !T())
          ? (y.call(
              this,
...
//# sourceMappingURL=546641dfde76ed00139ea2c3eae09499c5f2164a-eba2b75a08dfa4b564cf.js.map
